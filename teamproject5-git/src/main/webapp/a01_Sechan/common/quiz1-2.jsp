...
<div class="contentbox">
	...
	<form method="post">
	<label id="que1"><input type="radio" name="first" value="24"/>24개월</label>
	<label id="que2"><input type="radio" name="first" value="30"/>30개월</label>
	<label id="que3"><input type="radio" name="first" value="36"/>36개월</label>
	<label id="que4"><input type="radio" name="first" value="42"/>42개월</label>
	...
	<input id="nextbtn2" class="w-btn w-btn-indigo " type="button" value="힌트" onclick="hint()" />	
	</form>
	...
	%>
	<p>앞서 이야기했듯이 지구의 온도를 낮추지 않는다면 돌이킬수 없는 상황이 다가오게 됩니다. 하지만 이것마저 지켜야 하는 마지노선이 존재하고 있습니다.
	 2022년 기준 기후 변화에 관한 정부간 협의체인 IPCC에서는 **개월 안에 이상 기후 대책을 내지 않으면 기상이변을 돌이킬수 없다고 합니다.**의 개월수는 얼마일까요?
	</p>
	...
	function goNext(){
		...
		location.href="quiz1-3.jsp";
	}
	function hint(){
		alert("29개월보다 크고 31개월보다 작습니다!!");
