...
<h2>자유 게시판</h2>
<div class="container">
	<form id="frm01" action="${pageContext.request.contextPath }/freeBoardList.do"
		class="form-inline"  method="post">
		<select name="searchType">
			<option value="freeTitle" ${freeboard.searchType == 'freeTitle'?'selected':'' }>제목</option>
			<option value="freeWriter" ${freeboard.searchType == 'freeWriter'?'selected':'' }>작성자</option>
			<option value="freeContent" ${freeboard.searchType == 'freeContent'?'selected':'' }>내용</option>
			<option value="freeTitleContent" ${freeboard.searchType == 'freeTitleContent'?'selected':'' }>제목+내용</option>
		</select>
		<input class="form-control mr-sm-2" name="searchWord" type="text" placeholder="검색어 입력..."
			size="10" value="${freeboard.searchWord }"/>
