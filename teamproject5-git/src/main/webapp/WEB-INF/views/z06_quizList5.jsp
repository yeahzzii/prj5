...
<div class="contentbox">
	...
	<form method="post">
	<label id="que1"><input type="radio" name="first" value="30년"/>30년</label>
	<label id="que2"><input type="radio" name="first" value="40년"/>40년</label>
	<label id="que3"><input type="radio" name="first" value="45년"/>45년</label>
	<label id="que4"><input type="radio" name="first" value="50년"/>50년</label>
	...
	function goNext(){
		...
		if(point>3){
		location.href="${path}/resultSuccess.do";
		}else{
			location.href="${path}/resultFail.do";	
		}
		
		
	}
	function hint(){
		alert("소실된 빙하의 면적은 한반도 면적의 (32/4)배입니다!");
	...
	function tot_point(){
		var tot=0;
		if(getCookie('fir_ans')=="1")
			tot++;
		if(getCookie('sec_ans')=="1")
			tot++;
		if(getCookie('thir_ans')=="1")
			tot++;
		if(getCookie('four_ans')=="1")
			tot++;
		if(getCookie('fift_ans')=="1")
			tot++;		
		return tot;
	}
