...
<div class="contents-slider2">
	<div><img src="./img/product1.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-1.jsp'"></div>
	<div><img src="./img/product2.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-2.jsp'"></div>
	<div><img src="./img/product3.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-3.jsp'"></div>
	<div><img src="./img/product4.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-4.jsp'"></div>
	<div><img src="./img/product5.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-5.jsp'"></div>
	<div><img src="./img/product6.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-6.jsp'"></div>
	<div><img src="./img/product7.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-7.jsp'"></div>
	<div><img src="./img/product8.PNG" onclick="location.href='http://localhost:7080/teamproject5/a01_Yeji/Store/detail-8.jsp'"></div>
