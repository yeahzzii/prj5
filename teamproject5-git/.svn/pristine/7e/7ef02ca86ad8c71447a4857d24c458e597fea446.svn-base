...
<div class="contentbox">
	...
	<form method="post">
	<label id="que1"><input type="radio" name="first" value="인도네시아"/>인도네시아</label>
	<label id="que2"><input type="radio" name="first" value="독일"/>독일</label>
	<label id="que3"><input type="radio" name="first" value="영국"/>영국</label>
	<label id="que4"><input type="radio" name="first" value="중국"/>중국</label>
	...
	%>
	<p> 지구 온난화로 인해서 현재 해수면은 비약적으로 상승하고 있습니다. 이에 따라 전세계의 국가들은 저지대가 침수되는 문제를 해결하기 위해서 고민하고 있습니다.
		특히나 한반도의 경우는 해수면이 1.1미터만 상승하여도 일부 도시가 바다에 침수될 가능성이 높은 가운데 서해안과 남해안 부근은 모두 침수될것이라는 분석이 보고
		되고 있습니다. 이와 같이 전 세계중 해수면이 크게 오름으로써 큰 피해를 입게 되는 나라	는 어디일까요?
	</p>
