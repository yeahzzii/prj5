				...
				<div class="login_wrap_inner_2">
					...
					<div class="login_box">
						...
						<div class="login_input">
							<input type="text" name="id" placeholder="아이디를 입력해 주세요." maxlength="15" size="40" >
							<input type="password" name="password" placeholder="비밀번호를 입력해 주세요." maxlength="15" size="40">
							<input type= "checkbox" id ="idRemb" name="idRemb" class="mem2"><label for="idRemb">아이디 저장</label>
							<button type="submit" name="login" value="로그인" class="login_input_btn" style="width: 528px; height: 65px;">로그인</button>
						</div>
						<p class="login_txt">
