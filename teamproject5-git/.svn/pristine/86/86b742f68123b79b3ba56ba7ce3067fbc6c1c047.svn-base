...
<div class="contentbox">
	...
	<form method="post">
	<label id="que1"><input type="radio" name="first" value="3배"/>3배</label>
	<label id="que2"><input type="radio" name="first" value="4배"/>4배</label>
	<label id="que3"><input type="radio" name="first" value="6배"/>6배</label>
	<label id="que4"><input type="radio" name="first" value="8배"/>8배</label>
	...
	function goNext(){
		...
		location.href="${path}/quizList4.do";
	}
	function hint(){
