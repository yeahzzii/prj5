...
<div class="contentbox">
	...
	<form method="post">
	<label id="que1"><input type="radio" name="first" value="3"/>3배</label>
	<label id="que2"><input type="radio" name="first" value="4"/>4배</label>
	<label id="que3"><input type="radio" name="first" value="6"/>6배</label>
	<label id="que4"><input type="radio" name="first" value="8"/>8배</label>
	...
	%>
	<p>
		2021년 3월 31일 미국 항공우주국(NASA)에 따르면 21일 기준 북극해 위에 떠 있는 해빙 최대범위가 2007년과 동일한 기록인 역사상 7번째로 낮은 값에 도달했다고
		합니다. 보고서에 따르면 21일 도달한 북극 해빙 최대범위는 1,477만㎢로 1981년에서 2010년 평균 최대범위인 1,564만㎢보다 87만㎢ 낮고
		최저범위인 1,441만㎢보다 36만㎢ 높다고 하는데 손실된 해빙의 면적은 우리나라 면적의 몇배 일까요?
