				...
				<div class="login_wrap_inner_2">
					...
					<div class="login_box">
						...
						<div class="login_panel">
							<ul>
								<li><a href="http://localhost:7080/teamproject5/loginForm.do">로그인화면으로 돌아가기</a></li>
								<li><a href="http://localhost:7080/teamproject5/a01_Yeji/main/main2.jsp">메인화면으로 돌아가기</a></li>
								<li class="last"><a href="javascript:history.back()">이전화면으로 돌아가기</a></li>
							</ul>
						</div>
					</div>
				</div>
